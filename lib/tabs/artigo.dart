...
class Artigo extends StatefulWidget {
  _ArtigoState createState() => _ArtigoState();
}

class _ArtigoState extends State<Artigo> {
  ...
  var arreglox = [
    ...
    {"nombre": "ENSINO E APRENDIZAGEM INOVADORES COM TECNOLOGIAS", "tipo": "Artigo", "imagen": "ensino1.png", "descripcion": "Este artigo analisa como introduzir a Internet na Educação como uma nova mídia para a educação presencial e a distância. Focaliza principalmente o papel do professor como mediador, utilizando as novas tecnologias de forma mais participativa, trabalhando com projetos colaborativos e equilibarndo o presencial e o virtual e suas possibilidades.", "ranking": "4.5", "autor": "cramirezb", "datacriacao": "05/01/2019"},
    {"nombre": "Afetividade e processo ensino-aprendizagem: contribuições de Henri Wallon", "tipo": "Artigo", "imagen": "ensino2.jpg", "descripcion": "O texto discute conceitos fundamentais da teoria walloniana para a compreensão da dimensão afetiva e sua relevância no desenvolvimento do processo ensino - aprendizagem. ", "ranking": "3.5", "autor": "wandersonmed", "datacriacao": "05/01/2015"},
    {"nombre": "Estrategias de enseñanza y aprendizaje", "tipo": "Artigo", "imagen": "ensino3.jpg", "descripcion": "En este primer capítulo nos proponemos diferenciar, por una parte, entre las nociones de método, técnica y otros procedimientos curriculares relacionados con el concepto de estrategia de aprendizaje;", "ranking": "3.0", "autor": "Sadeer Dheyaa", "datacriacao": "05/01/2018"},
    {"nombre": "Fog Computing", "tipo": "Artigo", "imagen": "fogcomputing.jpg", "descripcion": "Conference: Computer Science Department", "ranking": "3.0", "autor": "Sadeer Dheyaa", "datacriacao": "05/01/2018"},
  ];
